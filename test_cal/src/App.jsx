...
function App() {
    ...
    let image = "https://images.pexels.com/photos/982585/pexels-photo-982585.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";

  return (
    <>
      <div className=''  id="cal">
        <Input_cal
      inv={first} 
...
<hr className='mt-4'></hr>
        <div className="flex font-sans mt-8">
